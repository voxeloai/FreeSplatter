...
#
# This is for the OPTIONAL autonomous mode of runpod-persistent-gpu-pod.
# Default mode is the pod-shell SSH sub-agent on Vlad's laptop, in which
# case this script is not needed.
#
# Persistence model:
...
WORKSPACE="/workspace"
REPO_DIR="${WORKSPACE}/FreeSplatter"
...
# ─────────────────────────────────────────────────────────────
# Step 7: CLAUDE.md + settings.local.json wired up in the FreeSplatter repo
# ─────────────────────────────────────────────────────────────
